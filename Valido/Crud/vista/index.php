            ...
            if(!empty($dato)): 
                foreach ($dato as $key => $fila):  ?>
                    <tr>
                        ...
                        <?php endforeach; ?>
                        <td>
                            <a class="btn" href="index.php?m=editar&id=<?php echo $fila['EquipoID']?>&table=<?php echo $_REQUEST['table']?>">EDITAR</a>
                            <a class="btn" href="index.php?m=eliminar&id=<?php echo $fila['EquipoID']?>&table=<?php echo $_REQUEST['table']?>" onclick="return confirm('ESTA SEGURO');">ELIMINAR</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
